...
╚═════╝  ╚═════╝  ╚═════╝ ╚═╝     ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝
      ...
      <div>
        <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm flex">
          <div className="flex flex-wrap flex-row p-4 opacity-90">
            <input className="flex bg-slate-500" type="file" ref={inputRef} />
            <button
              disabled={!!uploading}
              onClick={handleUploadClick}
              className="flex w-full relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800"
            >
              <LoadingSvg loading={uploading} />
              <span
                className={
                  "relative px-5 py-2.5 transition-all ease-in duration-75 bg-whidte dark:bg-grday-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent"
                }
              >
                keep it
              </span>
 ...
 \/\:\  \__  \:\~~\  \/__/ \:\/:/  \/__/ \:\  \ /:/  / \:\/:/ /:/  / \:\/:/ /:/  /
  ~~\:\/\__\  \:\  \        \::/__/       \:\  /:/  /   \::/_/:/  /   \::/ /:/  / 
     ...
     /:/  /     \:\__\        \:\__\        \::/  /       \::/  /        /:/  /   
     \/__/       \/__/         \/__/         \/__/         \/__/         \/__/     */}
      <div className="bg-slate-900s absoslute b-0 r-0 w-full h-auto rounded-xl p-4 sm:p-8 lg:p-12">
        <Media setUploading={setUploading} loading={!!uploading} />
      </div>
